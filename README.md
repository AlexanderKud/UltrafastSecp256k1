...
- Every commit runs 1,000,000+ assertions across 130 non-exploit audit modules and 270 exploit PoCs ( 401 modules total; count via `python3 ci/sync_module_count.py`; canonical data: `docs/canonical_numbers.json`)
