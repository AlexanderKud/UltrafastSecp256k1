...
| Audit modules | 425 across 9 failure classes |
...
**Verdict**: **CAAS Self-Audit Verdict: AUDIT-READY (self-generated continuous audit; no external third-party security audit has been completed)** -- 425 modules, 9 failure classes
...
|----------------------|---------------------------------------------|
| Audit Sections       | 8                                           |
| Audit Modules        | 156 (non-exploit modules) |
