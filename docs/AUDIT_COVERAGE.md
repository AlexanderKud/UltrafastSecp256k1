...
| Audit modules | 397 across 9 failure classes |
...
**Verdict**: **CAAS Self-Audit Verdict: AUDIT-READY (self-generated continuous audit; no external third-party security audit has been completed)** -- 397 modules, 9 failure classes
...
|----------------------|---------------------------------------------|
| Audit Sections       | 8                                           |
| Audit Modules        | 127 (non-exploit modules) |
