...
| Audit modules | 376 across 9 failure classes |
| Exploit PoC tests | 264 exploit PoCs test files, 200+ attack vectors |
...
| **Exploit PoC Tests** | **264 tests across 20+ attack categories** (`audit/test_exploit_*.cpp`) |
