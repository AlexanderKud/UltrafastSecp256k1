...
| 264 exploit PoCs catalog | [`docs/EXPLOIT_TEST_CATALOG.md`](EXPLOIT_TEST_CATALOG.md) |
...
- **264 exploit PoCs tests** covering known attack classes against secp256k1 — all pass on every commit.
