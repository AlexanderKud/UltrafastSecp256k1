...
| **OpenSats** (`opensats.org`) | Free and open-source Bitcoin contributors and projects | 264 exploit PoCs, MIT license, public CAAS evidence bundle, adopter case study |
...
5. **Audit proof**: 264 exploit PoCs (catalog in `docs/EXPLOIT_TEST_CATALOG.md`), 60 non-exploit audit modules, 12/12 CAAS hardening items closed (`docs/AUDIT_DASHBOARD.md`), reproducible-build attestation across GitHub Actions / GitLab CI / Woodpecker (Codeberg).
