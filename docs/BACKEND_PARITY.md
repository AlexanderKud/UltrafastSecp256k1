...
| **Audit runner** | `unified_audit_runner` (157 non-exploit + 269 exploit PoCs = 426 modules) | `gpu_audit_runner` ( 426 modules) | `opencl_audit_runner` ( 426 modules) | `metal_audit_runner` ( 426 modules) |
