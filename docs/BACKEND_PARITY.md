...
| **Audit runner** | `unified_audit_runner` (60 non-exploit + 273 exploit PoCs = 249 modules) | `gpu_audit_runner` ( 409 modules) | `opencl_audit_runner` ( 409 modules) | `metal_audit_runner` ( 409 modules) |
