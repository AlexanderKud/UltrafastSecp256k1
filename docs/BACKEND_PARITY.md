...
| **Audit runner** | `unified_audit_runner` (60 non-exploit + 271 exploit PoCs = 249 modules) | `gpu_audit_runner` ( 402 modules) | `opencl_audit_runner` ( 402 modules) | `metal_audit_runner` ( 402 modules) |
