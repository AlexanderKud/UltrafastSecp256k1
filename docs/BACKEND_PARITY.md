...
| **Audit runner** | `unified_audit_runner` (60 non-exploit + 269 exploit PoCs = 249 modules) | `gpu_audit_runner` ( 385 modules) | `opencl_audit_runner` ( 385 modules) | `metal_audit_runner` ( 385 modules) |
