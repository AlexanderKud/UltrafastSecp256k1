...
| **Audit runner** | `unified_audit_runner` (60 non-exploit + 264 exploit PoCs = 249 modules) | `gpu_audit_runner` (47 modules) | `opencl_audit_runner` (40 modules) | `metal_audit_runner` (30 modules) |
