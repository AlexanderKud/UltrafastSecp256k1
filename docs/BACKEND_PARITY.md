...
| **Audit runner** | `unified_audit_runner` (60 non-exploit + 273 exploit PoCs = 249 modules) | `gpu_audit_runner` ( 407 modules) | `opencl_audit_runner` ( 407 modules) | `metal_audit_runner` ( 407 modules) |
