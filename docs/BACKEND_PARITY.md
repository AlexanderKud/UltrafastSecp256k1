...
| **Audit runner** | `unified_audit_runner` (149 non-exploit + 269 exploit PoCs = 418 modules) | `gpu_audit_runner` ( 420 modules) | `opencl_audit_runner` ( 420 modules) | `metal_audit_runner` ( 420 modules) |
