...
| **Audit runner** | `unified_audit_runner` (150 non-exploit + 270 exploit PoCs = 420 modules) | `gpu_audit_runner` ( 420 modules) | `opencl_audit_runner` ( 420 modules) | `metal_audit_runner` ( 420 modules) |
