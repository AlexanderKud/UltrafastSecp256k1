...
| **Audit runner** | `unified_audit_runner` (148 non-exploit + 270 exploit PoCs = 418 modules) | `gpu_audit_runner` ( 418 modules) | `opencl_audit_runner` ( 418 modules) | `metal_audit_runner` ( 418 modules) |
