...
| **Audit runner** | `unified_audit_runner` (158 non-exploit + 269 exploit PoCs = 427 modules) | `gpu_audit_runner` ( 427 modules) | `opencl_audit_runner` ( 427 modules) | `metal_audit_runner` ( 427 modules) |
