...
| **Audit runner** | `unified_audit_runner` (156 non-exploit + 269 exploit PoCs = 425 modules) | `gpu_audit_runner` ( 425 modules) | `opencl_audit_runner` ( 425 modules) | `metal_audit_runner` ( 425 modules) |
