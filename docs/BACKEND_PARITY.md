...
| **Audit runner** | `unified_audit_runner` (152 non-exploit + 269 exploit PoCs = 421 modules) | `gpu_audit_runner` ( 421 modules) | `opencl_audit_runner` ( 421 modules) | `metal_audit_runner` ( 421 modules) |
