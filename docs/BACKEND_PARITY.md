...
| **Audit runner** | `unified_audit_runner` (154 non-exploit + 269 exploit PoCs = 423 modules) | `gpu_audit_runner` ( 423 modules) | `opencl_audit_runner` ( 423 modules) | `metal_audit_runner` ( 423 modules) |
