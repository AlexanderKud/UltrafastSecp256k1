...
| **Audit runner** | `unified_audit_runner` (60 non-exploit + 270 exploit PoCs = 249 modules) | `gpu_audit_runner` ( 401 modules) | `opencl_audit_runner` ( 401 modules) | `metal_audit_runner` ( 401 modules) |
