...
| **Audit runner** | `unified_audit_runner` (155 non-exploit + 269 exploit PoCs = 424 modules) | `gpu_audit_runner` ( 424 modules) | `opencl_audit_runner` ( 424 modules) | `metal_audit_runner` ( 424 modules) |
