...
| **Audit runner** | `unified_audit_runner` (160 non-exploit + 269 exploit PoCs = 429 modules) | `gpu_audit_runner` ( 429 modules) | `opencl_audit_runner` ( 429 modules) | `metal_audit_runner` ( 429 modules) |
