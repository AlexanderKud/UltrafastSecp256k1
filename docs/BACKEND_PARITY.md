...
| **Audit runner** | `unified_audit_runner` (60 non-exploit + 270 exploit PoCs = 249 modules) | `gpu_audit_runner` ( 417 modules) | `opencl_audit_runner` ( 417 modules) | `metal_audit_runner` ( 417 modules) |
