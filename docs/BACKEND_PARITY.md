...
| **Audit runner** | `unified_audit_runner` (153 non-exploit + 269 exploit PoCs = 422 modules) | `gpu_audit_runner` ( 422 modules) | `opencl_audit_runner` ( 422 modules) | `metal_audit_runner` ( 422 modules) |
