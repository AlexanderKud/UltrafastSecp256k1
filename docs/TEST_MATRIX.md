...
| `unified_audit_runner.cpp` | 420 modules (150 non-exploit + 270 exploit PoCs) | Unified audit: all current modules in single binary (includes GPU null-guard paths) |
