...
| `unified_audit_runner.cpp` | 418 modules (148 non-exploit + 270 exploit PoCs) | Unified audit: all current modules in single binary (includes GPU null-guard paths) |
