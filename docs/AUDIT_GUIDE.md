...
### What It Tests ( 131 non-exploit modules + 270 exploit PoC tests + standalone audit surfaces)
...
### OpenCL Audit Runner ( 401 modules, 8 sections)
...
### Metal Audit Runner ( 401 modules, 8 sections)
...
| `opencl/src/opencl_audit_runner.cpp` | OpenCL GPU audit runner ( 401 modules) |
| `metal/src/metal_audit_runner.mm` | Metal GPU audit runner ( 401 modules) |
