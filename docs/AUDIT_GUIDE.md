...
### What It Tests ( 136 non-exploit modules + 273 exploit PoC tests + standalone audit surfaces)
...
### OpenCL Audit Runner ( 409 modules, 8 sections)
...
### Metal Audit Runner ( 409 modules, 8 sections)
...
| `opencl/src/opencl_audit_runner.cpp` | OpenCL GPU audit runner ( 409 modules) |
| `metal/src/metal_audit_runner.mm` | Metal GPU audit runner ( 409 modules) |
