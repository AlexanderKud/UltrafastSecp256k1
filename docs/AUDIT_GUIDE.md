...
### What It Tests ( 131 non-exploit modules + 271 exploit PoC tests + standalone audit surfaces)
...
### OpenCL Audit Runner ( 402 modules, 8 sections)
...
### Metal Audit Runner ( 402 modules, 8 sections)
...
| `opencl/src/opencl_audit_runner.cpp` | OpenCL GPU audit runner ( 402 modules) |
| `metal/src/metal_audit_runner.mm` | Metal GPU audit runner ( 402 modules) |
