...
### What It Tests ( 138 non-exploit modules + 273 exploit PoC tests + standalone audit surfaces)
...
### OpenCL Audit Runner ( 411 modules, 8 sections)
...
### Metal Audit Runner ( 411 modules, 8 sections)
...
| `opencl/src/opencl_audit_runner.cpp` | OpenCL GPU audit runner ( 411 modules) |
| `metal/src/metal_audit_runner.mm` | Metal GPU audit runner ( 411 modules) |
