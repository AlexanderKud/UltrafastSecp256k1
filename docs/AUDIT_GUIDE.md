...
### What It Tests ( 132 non-exploit modules + 273 exploit PoC tests + standalone audit surfaces)
...
### OpenCL Audit Runner ( 405 modules, 8 sections)
...
### Metal Audit Runner ( 405 modules, 8 sections)
...
| `opencl/src/opencl_audit_runner.cpp` | OpenCL GPU audit runner ( 405 modules) |
| `metal/src/metal_audit_runner.mm` | Metal GPU audit runner ( 405 modules) |
