...
### What It Tests ( 135 non-exploit modules + 273 exploit PoC tests + standalone audit surfaces)
...
### OpenCL Audit Runner ( 408 modules, 8 sections)
...
### Metal Audit Runner ( 408 modules, 8 sections)
...
| `opencl/src/opencl_audit_runner.cpp` | OpenCL GPU audit runner ( 408 modules) |
| `metal/src/metal_audit_runner.mm` | Metal GPU audit runner ( 408 modules) |
