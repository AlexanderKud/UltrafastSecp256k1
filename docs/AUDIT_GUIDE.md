...
### What It Tests ( 154 non-exploit modules + 269 exploit PoC tests + standalone audit surfaces)
...
### OpenCL Audit Runner ( 423 modules, 8 sections)
...
### Metal Audit Runner ( 423 modules, 8 sections)
...
| `opencl/src/opencl_audit_runner.cpp` | OpenCL GPU audit runner ( 423 modules) |
| `metal/src/metal_audit_runner.mm` | Metal GPU audit runner ( 423 modules) |
