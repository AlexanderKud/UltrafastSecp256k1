...
### What It Tests ( 127 non-exploit modules + 270 exploit PoC tests + standalone audit surfaces)
...
### OpenCL Audit Runner ( 397 modules, 8 sections)
...
### Metal Audit Runner ( 397 modules, 8 sections)
...
| `opencl/src/opencl_audit_runner.cpp` | OpenCL GPU audit runner ( 397 modules) |
| `metal/src/metal_audit_runner.mm` | Metal GPU audit runner ( 397 modules) |
