...
### What It Tests ( 123 non-exploit modules + 270 exploit PoC tests + standalone audit surfaces)
...
### OpenCL Audit Runner ( 393 modules, 8 sections)
...
### Metal Audit Runner ( 393 modules, 8 sections)
...
| `opencl/src/opencl_audit_runner.cpp` | OpenCL GPU audit runner ( 393 modules) |
| `metal/src/metal_audit_runner.mm` | Metal GPU audit runner ( 393 modules) |
