...
### What It Tests ( 160 non-exploit modules + 269 exploit PoC tests + standalone audit surfaces)
...
### OpenCL Audit Runner ( 429 modules, 8 sections)
...
### Metal Audit Runner ( 429 modules, 8 sections)
...
| `opencl/src/opencl_audit_runner.cpp` | OpenCL GPU audit runner ( 429 modules) |
| `metal/src/metal_audit_runner.mm` | Metal GPU audit runner ( 429 modules) |
