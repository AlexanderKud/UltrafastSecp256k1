...
### What It Tests ( 116 non-exploit modules + 269 exploit PoC tests + standalone audit surfaces)
...
### OpenCL Audit Runner ( 385 modules, 8 sections)
...
### Metal Audit Runner ( 385 modules, 8 sections)
...
| `opencl/src/opencl_audit_runner.cpp` | OpenCL GPU audit runner ( 385 modules) |
| `metal/src/metal_audit_runner.mm` | Metal GPU audit runner ( 385 modules) |
