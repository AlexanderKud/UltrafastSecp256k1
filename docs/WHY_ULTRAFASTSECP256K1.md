...
| Exploit PoC tests | 264 dedicated adversarial PoC modules across 20+ coverage categories (`audit/test_exploit_*.cpp`) | 264 wired, 0 failures |
...
| **Total (audit runner)** | **unified_audit_runner** across 107 non-exploit modules + 264 exploit PoC modules (371 total) | **~1,000,000+** |
| **Total (exploit PoC tests)** | **264 exploit PoC modules** across 20+ coverage categories, all in `audit/test_exploit_*.cpp` | **264 modules, 0 failures** |
