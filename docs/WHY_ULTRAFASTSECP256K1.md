...
| Exploit tests | 257 PoC files, 263 registered modules, 0 failures |
...
| **Total (audit runner)** | **unified_audit_runner** across 106 non-exploit modules + 263 exploit-PoC modules (367 total) | **~1,000,000+** |
| **Total (exploit PoC tests)** | **263 exploit-PoC modules** across 20+ coverage categories, all in `audit/test_exploit_*.cpp` | **261 modules, 0 failures** |
