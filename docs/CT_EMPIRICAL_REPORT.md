...
**UltrafastSecp256k1 v4.3.0** -- Statistical Timing Analysis
...
> variance** in any `ct::` namespace operation of UltrafastSecp256k1 v4.3.0.
>
...
*UltrafastSecp256k1 v4.3.0 — CT Empirical Proof Report v2.0*
