...
**UltrafastSecp256k1 v4.2.1** -- Statistical Timing Analysis
...
> variance** in any `ct::` namespace operation of UltrafastSecp256k1 v4.2.1.
>
...
*UltrafastSecp256k1 v4.2.1 — CT Empirical Proof Report v2.0*
