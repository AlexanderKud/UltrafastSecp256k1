...
- Audited via `opencl_audit_runner` ( 389 modules including CT sections)
...
- Audited via `metal_audit_runner` ( 389 modules including CT sections)
...
- **OpenCL**: `opencl_audit_runner` ( 389 modules including CT signing + CT ZK sections)
- **Metal**: `metal_audit_runner` ( 389 modules including CT signing + CT ZK sections)
