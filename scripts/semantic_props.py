...
Usage::
    ...
    python3 scripts/semantic_props.py
    python3 scripts/semantic_props.py --lib /path/to/libufsecp.so.3
    python3 scripts/semantic_props.py --json -o report.json
    # As a pytest module:
    pytest scripts/semantic_props.py
"""
...
# ---------------------------------------------------------------------------
# pytest entry points (when run as `pytest scripts/semantic_props.py`)
# ---------------------------------------------------------------------------
