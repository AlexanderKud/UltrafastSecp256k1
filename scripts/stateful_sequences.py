...
Usage::
    python3 scripts/stateful_sequences.py --lib /path/to/libufsecp.so.3
    python3 scripts/stateful_sequences.py --json -o report.json
    python3 scripts/stateful_sequences.py --count 200  # iterations per sequence
"""
