...
| [AUDIT_REPORT.md](AUDIT_REPORT.md) | Internal audit report (v4.2.1 baseline; test suite significantly restructured since -- see below) |
...
*UltrafastSecp256k1 v4.2.1 -- Security Policy*
